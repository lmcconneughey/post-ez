         ...
         <div className="flex items-center justify-between my-2 text-textGray">
            <div className="flex items-center justify-between gap-4">
                ...
                <div className="group flex items-center cursor-pointer space-x-2">
                    ...
                    <span className="group-hover:text-iconBlue text-sm">132</span>
                </div>
                 {/* repost */}
                 <div className="group flex items-center cursor-pointer space-x-2">
                    <svg 
                    ...
                    <span className="group-hover:text-iconGreen text-sm">132</span>
                </div>
                {/* likes */}
                <div className="group flex items-center cursor-pointer space-x-2">
                    <svg 
                    ...
                    <span className="group-hover:text-iconPink text-sm">132</span>
                </div> 
            </div>
